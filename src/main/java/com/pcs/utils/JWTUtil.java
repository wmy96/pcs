...
public class JWTUtil {
	 ...
	 * 而payload又包含几个部分,issuer签发者,subject面向用户,iat签发时间,exp过期时间,aud接收方。 @Title:
	 * generToken @Description: TODO @param: @param id 用户id @param: @param issuer
	 * 签发者 @param: @param subject 一般用户名 @param: @return @return: String @throws
	 */
	...
	/**
	 * 该函数用于更新token @Title: updateToken @Description: TODO @param: @param
	 * token @param: @return @return: String @throws
	 */
	...
	/**
	 * 将token解密出来,将payload信息包装成Claims类返回 @Title: verifyToken @Description:
	 * TODO @param: @param token @param: @return @return: Claims @throws
	 */
